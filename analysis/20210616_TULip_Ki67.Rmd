...
In addition to non-responders, a *participant dropout rate of 5%* was included into simulations.
...
expected %>%
  ...
  pander(
    ...
    Values were set to show a slight overestimate of reduction, given that a varying proportion of non-responders were to be included in the simulations.
    Reductions obtained below in simulations were more reflective of the intended values.
    "
  )
```
